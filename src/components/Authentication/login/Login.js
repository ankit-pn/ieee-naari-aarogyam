          ...
          <div className="login-wrap p-4 p-md-5">
            <div className="d-flex" style={{ marginBottom: "50px" }}>
              <div className="w-100">
                ...
                >
                  <Link to="patient">
                    <ToggleButton className="toggleBtn" value="patient">
                      Patient
                    </ToggleButton>
                  </Link>
                  <Link to="hospital">
                    <ToggleButton className="toggleBtn" value="hospital">
                      Hospital
                    </ToggleButton>
                  </Link>
                </ToggleButtonGroup>
            ...
            <p className="text-center">
              Not a member?{" "}
              <Link className='link' data-toggle="tab" to="/signup/*" onClick={sign_up}>
                Sign Up
              </Link>
            </p>
          </div>
